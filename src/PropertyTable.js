...
propertyTable.swcHTML = function(lineNum, length){
	var dropdownText = "<div class='dropdown' > <b>Type:</b> <button type='button' class='btn btn-default dropdown-toggle' id='SWCDropDownButtonAt"+lineNum+"And"+length+"'  data-toggle='dropdown'>Select Transmission Type <span class='caret'></span></button> <ul class='dropdown-menu' role='menu' id='SWCDropDownAt"+lineNum+"And"+length+"' aria-labelledby='dropdownMenu1' >";
    ...
    dropdownText = dropdownText + "<div class='dropdown' id='SWCDropDownContainerNested5At"+lineNum+"And"+length+"' style='padding:5px;'></div>"; //For Range (if needed)
